package com.roger.springcloudGreenwich.rules;
 ...
 */
@Slf4j
public class ProductServerLoadBalanceRule extends AbstractLoadBalancerRule {
    /**
    ...
    public Server choose(Object key) {
        ...
        while (server == null) {
            ...
            log.info("product server可用服务列表个数：{}",upList.size());
            // 获取所有服务列表
